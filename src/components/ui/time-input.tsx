...
export default function TimeInput ({ timeStamp }: TimeImputProps) {
  ...
  return (
    <div
      className='flex w-fit py-0.5 px-1 rounded-sm bg-white border'
    >
      <input
        className='w-6 no-arrows pl-0.5 bg-transparent border-0 outline-none'
        type='number'
      ...
      <span>,</span>
      <input
        className='w-8 no-arrows pl-0.5 bg-transparent border-0 outline-none'
        type='number'
